#Import and install necessary packages (uncomment install.packages on first run)
#install.packages(c("readxl", "netmeta", "tidyverse"))
library(tidyverse)
library(readxl)
library(netmeta)
library(dplyr)
...
# Import dataset. Place Chronic_Migraine_Dataset.xlsx in ./data/ relative to this script.
# (The dataset is not redistributed here; see this project's README.)
my_data <- read_excel("data/Chronic_Migraine_Dataset.xlsx")
