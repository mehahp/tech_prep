-- ============================================================================
-- SQL SOLUTIONS for problems.md  (run against prep.db)
-- Peek only AFTER you've attempted a problem.
-- Each is a complete, runnable statement. Test one with, e.g.:
--   python3 query.py "$(sed -n '/-- Q16/,/-- Q17/p' solutions.sql)"
-- or just copy the query body.
-- These are written in portable SQL; SQLite-specific bits (strftime) are noted.
-- ============================================================================
